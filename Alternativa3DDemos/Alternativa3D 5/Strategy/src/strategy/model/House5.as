package strategy.model {
	...
	public class House5 extends Mesh {

		private var texture:Texture;
		
		public function House5(texture:Texture) {
			super("House5");
			this.texture = texture;
			this.mobility = 1;
			coords = new Point3D(2892.2436186718337, 1090.9052158035418, -11.33651734554405);

			createVertex(881.6492867876764, -504.77229055377126, -1733.8992052592419, 2);
			...
			createSurface([0, 2, 3, 1], "house_1");
			setMaterialToSurface(new TextureMaterial(texture, 1, true, false, BlendMode.NORMAL, -1, 0x000000, 25), "house_1");
		}
	}
}