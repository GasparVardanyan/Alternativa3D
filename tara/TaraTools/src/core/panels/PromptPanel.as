package core.panels
{
	 ...
	 * @author Gaspar
	 */
	public class PromptPanel extends PanelsBase
	{
		public var g_lab_message:Label = new Label();
		public var g_btn_ok:Button;
		public var g_inp_input:TextInput = new TextInput();
		...
		override protected function addedToGUI(callback:Function = null):void
		{
			...
			{
				close();
				if (callback != null) callback(g_inp_input.text);
			});
		...
		override protected function afterDraw():void
		{
			...
			g_btn_ok.width = 100;
			g_btn_ok.y = g_inp_input.y = heightUsed + 4;
			g_btn_ok.x = w - 150;
			g_inp_input.x = 50;
			g_inp_input.width = w - 200;
		}
		
		override protected function removedFromGUI():void
		{
			g_inp_input.tf.displayAsPassword = false;
		}
	}
}