package alternativaphysics.debug {
	...
	import alternativaphysics.collision.dispatch.A3DRay;
	...
	import alternativaphysics.data.A3DTypedConstraintType;
	import alternativaphysics.dynamics.A3DDynamicsWorld;
	import alternativaphysics.dynamics.constraintsolver.*;
	...
	public class A3DDebugDraw {
		...
		*/
		public function debugDrawWorld():void {
			...
			{
				var color:uint;
				for each (var obj:A3DCollisionObject in _physicsWorld.rigidBodies) {
