package alternativa.math {
	...
	public class Matrix4 {
		...
		/**
		 * Трансформирует координаты точки.
		 * 
		 * @param vin входная точка
		...
		/**
		 * Выполняет обратную трансформацию точки. При этом подразумевается, что квадратная матрица содержит только вращения.
		 * 
		 * @param vin входная точка
		 * @param vout вектор, в который записывается результат трансформации
		 */
