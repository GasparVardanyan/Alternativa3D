...
//				if (bbPos.vDot(colAxis) < offset) return false;
				...
				boxTransform.transformPointsN(points1, points2, 4);
				rectTransform.transformPointsTransposedN(points2, points1, 4);
				...
				rectTransform.transformPointsN(points1, points2, 4);
				boxTransform.transformPointsTransposedN(points2, points1, 4);
