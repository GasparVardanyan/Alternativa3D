package alternativa.math {
	...
	/**
	 * Матрица 3x3, используемая для описания ориентации.
	 */
	public class Matrix3 {
		 ...
		 * 
		 * @param m правый операнд умножения
		 */
		 ...
		 *  
		 * @param m матрица, значения которой копируются
		 */
		...
		/**
		 * Устанавливает вращательную часть матрицы на основе указанных эйлеровых углов.
		 *
		 * @param rx угол поворота по оси X в радианах
		 * @param ry угол поворота по оси Y в радианах
		 * @param rz угол поворота по оси Z в радианах
		 */
