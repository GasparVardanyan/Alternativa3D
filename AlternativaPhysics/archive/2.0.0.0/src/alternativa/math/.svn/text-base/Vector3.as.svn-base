package alternativa.math {
	...
	public class Vector3 {
		...
		/**
		 * Трансформирует вектор заданной матрицей.
		 * 
		...
		/**
		 * Трансформирует вектор транспонированной заданной матрицей.
		 *
		 * @param m матрица трансформации
		 * @return this
		 */
		...
		/**
		 * Выполняет обратную трансформацию заданной матрицей. Матрица должна быть ортогональной.
		 *
		...
		/**
		 * Выполняет трансформацию вектора матрицей без учёта смещения.
		 * 
		 * @param m матрица трансформации
		 * @return this
		 */
