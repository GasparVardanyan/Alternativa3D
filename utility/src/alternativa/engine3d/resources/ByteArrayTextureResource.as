...
package alternativa.engine3d.resources {
	 ...
	 */
	public class ByteArrayTextureResource extends TextureResource {
         ...
         */
		public function ByteArrayTextureResource(byteArray:ByteArray, resizeForGPU:Boolean = false) {
			this.byte = byteArray;
			this.resizeForGPU = resizeForGPU;
			_texture = Helpers.CONTEXT.createTexture(256, 256, Context3DTextureFormat.BGRA, false);
		}
		...
		public function setData(byte:ByteArray):void
		{
			...
			loader = new Loader();
			loader.contentLoaderInfo.addEventListener(Event.COMPLETE, decoded);
			loader.loadBytes(this.byte);			
		}

		/**
		 * @inheritDoc 
		 */
		private function uploadComplette():void {
			var context3D:Context3D=Helpers.CONTEXT;
		...
		public function onCompleteEvent(func:Function):void
		{
			this.func=func;
		}
