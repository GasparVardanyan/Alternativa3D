package alternativa.gui.lod.auto {
	...
	/**
	 * Лодируемый объект, выбирающий лод в зависимости от заданных ему размеров.
	 * 
	 */	
	public class AutoLODobject extends GUIobject implements IAutoLODobject {
		...
		public function AutoLODobject() {
			limitsV = new Vector.<int>();
			limitsH = new Vector.<Vector.<int>>();
		}
		
		/**
		 * Выбирается интервал, в который попадает заданный размер.
